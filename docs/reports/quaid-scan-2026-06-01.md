# quaid-scanner Report: /Users/karstenwade/Projects/AINative-Studio/src/founderhouse

**Score:** 🔴 2.1/10 — CRITICAL risk
**Maturity:** sandbox | **Depth:** standard | **Duration:** 0.1s
**Scanned:** 2026-06-01T21:32:52.774Z
...
- **[vendor-neutrality-high-concentration]** High vendor concentration: ainative.studio (88% of commits) *(Encourage contributions from additional organizations to improve vendor diversity)*
...
- **[bus-factor-1]** Bus factor: 1, Elephant factor: 88% (2 contributors, 43 commits in last 12 months)
...
- **[vendor-neutrality-domain-count]** Found 2 unique email domain(s) across 43 commits
...
- **[contributor-data-1]** 2 unique contributors with 43 commits in the last 12 months
...
- **[AK-GIT-CLONE-README.md:42]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-CLONE-README.md:43]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-CLONE-README.md:60]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-CLONE-README.md:61]** Assumed knowledge: "clone" operation used without explanation
- **[AK-GIT-FORK-README.md:269]** Assumed knowledge: "fork" operation used without explanation
- **[AK-GIT-BRANCH-README.md:270]** Assumed knowledge: "branch" operation used without explanation
- **[AK-ACRONYM-LICENSE-README.md:6]** Undefined acronym "LICENSE" may confuse newcomers
- **[AK-ACRONYM-KPI-README.md:16]** Undefined acronym "KPI" may confuse newcomers
- **[AK-ACRONYM-MCP-README.md:18]** Undefined acronym "MCP" may confuse newcomers
- **[AK-ACRONYM-CONTRIBUTING-README.md:88]** Undefined acronym "CONTRIBUTING" may confuse newcomers
- **[AK-ACRONYM-DEPLOYMENT-README.md:89]** Undefined acronym "DEPLOYMENT" may confuse newcomers
...
- **[AK-GIT-BRANCH-CONTRIBUTING.md:388]** Assumed knowledge: "branch" operation used without explanation
- **[AK-ACRONYM-PEP-CONTRIBUTING.md:232]** Undefined acronym "PEP" may confuse newcomers
- **[AK-ACRONYM-MESSAGE-CONTRIBUTING.md:244]** Undefined acronym "MESSAGE" may confuse newcomers
...
---
*quaid-scanner v0.1.2 | 2026-06-01T21:32:52.774Z*
*Commit: dcd43119d801451f8d887e9cacc118f58f0a0bb2*